...
const CARD_LAYOUT_DECK_KEY = "musicFlashcardsCardLayoutDeck";
...
const cardLayoutDeck = deckHistoryKey(CARD_LAYOUT_DECK_KEY);
...
export const cardLayoutFromHistoryState = cardLayoutDeck.read;
export const historyStateForCardLayout = cardLayoutDeck.write;
